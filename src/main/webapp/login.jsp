...
<body class="my-5">
	<!-- Add Bootstrap margin utility for top and bottom -->
				...
				<div class="card form-card">
					<div class="card-body">
						<form action="userlogin" method="post">
							<div class="mb-3">
				<label for="email" class="form-label small">Email</label> <input
							...
							if (message != null) {
							%>
							<div class="alert alert-warning text-warning small mb-3"
								role="alert">
