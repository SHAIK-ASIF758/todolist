			...
			if(u!=null) {
		        ...
		        Session session = Session.getInstance(props, new Authenticator() {
		            ...
		            protected PasswordAuthentication getPasswordAuthentication() {
		                ...
		                return new PasswordAuthentication("shaikasif43210@gmail.com", "xgnpswyvjzybgalv");
		            }
		        });
		        ...
		        message.setFrom(new InternetAddress("shaikasif938341@gamil.com")); // Replace with your email
